...
<head>
  ...
  <title>Index - Perpustakaan SMA 7 Sijunjung</title>
...
<body class="index-page">
  ...
  <img src="{{ asset('assets/img/logo_sekolah.png') }}" alt="Logo SMA 7" style="max-height: 55px; width: auto; margin-right: 15px;">
  
  <h1 class="sitename" style="display: flex; flex-direction: column; line-height: 1.2; margin: 0;">
    <span style="font-weight: 800; font-size: 18px; letter-spacing: 1px; color: #ffffff;">PERPUSTAKAAN</span>
    <span style="font-weight: 400; font-size: 11px; color: #f1c40f; letter-spacing: 1.5px;">SMA NEGERI 7 SIJUNJUNG</span>
  </h1>
</a>
  ...
  <ul>
    ...
    <li class="dropdown">
      <a href="#">
        <span>Profile</span> <i class="bi bi-chevron-down toggle-dropdown"></i>
      </a>
      <ul>
        <li><a href="{{ url('/sejarah') }}">Sejarah</a></li>
        <li><a href="{{ url('/visimisi') }}">Visi dan Misi</a></li>
        <li><a href="{{ url('/struktur') }}">Struktur Organisasi</a></li>
        <li><a href="{{ url('/staff') }}">Staff Perpustakaan</a></li>
    ...
    <li class="dropdown">
      <a href="#">
        <span>Galeri</span> <i class="bi bi-chevron-down toggle-dropdown"></i>
      </a>
      <ul>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-4">
            <h1 data-aos="fade-up">Gerakan Literasi Sekolah atau Jelajahi Ilmu Pengetahuan</h1>
            <blockquote data-aos="fade-up" data-aos-delay="100">
              <p>"Perpustakaan SMA N 7 Sijunjung adalah pusat sumber belajar yang mendukung peningkatan minat baca dan pencapaian akademik siswa. Mari kembangkan potensi dan wawasan Anda bersama kami." </p>
            </blockquote>
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="post-box">
              ...
              <a href="galeri-video.html" class="readmore stretched-link"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
          ...
          galeri-video.html" class="readmore stretched-link"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-about">
            <a href="{{ url('/') }}" class="logo d-flex align-items-center">
              <span class="sitename">Perpustakaan SMA 7 Sijunjung</span>
            </a>
